package subGame.zanlongchuanqi
{
	...
	import subGame.zanlongchuanqi.wylib.Packs.BitmapPack.MDPBitmapPackage;
	...
	public class Analyze
	{
		...
		public function ana(ba:ByteArray, $foldName:String, isGenerateAtf:Boolean = false):void
		{
			...
			mdpPackger = new MDPBitmapPackage();
		...
		private var mdpPackger:MDPBitmapPackage;
