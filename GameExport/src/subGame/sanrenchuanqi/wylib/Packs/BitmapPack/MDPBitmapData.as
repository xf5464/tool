package subGame.sanrenchuanqi.wylib.Packs.BitmapPack
{
   ...
   import subGame.sanrenchuanqi.wylib.Packs.BitmapPack.Internal.MDPBitmapDataLoadQueue;
   ...
   public class MDPBitmapData extends MDPackFile
   {
	  ...
	  public function loadBitmapDataSr(param1:ByteArray, param2:int, param3:int) : void
	  {
		  BitmapDataLoadQueue.requestLoadBitmapData(param1,param2,param3,this.loadBmpDataComplete);
		  m_ExtDataRec = null;
		  m_FileDataRec = null;
	  }
