package subGame.fengtian.zip
{
   ...
   public class ZipFile
   {
      ...
      public function getInput(param1:ZipEntry) : ByteArray
      {
         ...
         var _loc2_:uint = this.buf.readUnsignedShort();
         var _loc3_:ByteArray = new ByteArray();
         _loc3_.writeMultiByte(param1.name,"gb2312");
         this.buf.position = this.buf.position + (_loc3_.length + _loc2_);
      ...
      private function readEntries() : void
      {
         ...
         while(_loc1_ < this.entryList.length)
         {
            ...
            _loc4_ = new ZipEntry(this.buf.readMultiByte(_loc3_,"gb2312"));
            _loc3_ = _loc2_.readUnsignedShort();
